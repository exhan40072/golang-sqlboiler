...
var PilotWhere = struct {
	...
	ID:   whereHelperuint{field: "`pilots`.`id`"},
...
func FindPilot(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) (*Pilot, error) {
	pilotObj := &Pilot{}
...
func PilotExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	var exists bool
