...
var JetWhere = struct {
	...
	ID:      whereHelperuint{field: "`jets`.`id`"},
...
func FindJet(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) (*Jet, error) {
	jetObj := &Jet{}
...
func JetExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	var exists bool
